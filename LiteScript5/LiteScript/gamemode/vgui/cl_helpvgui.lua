...
function Panel:Init()
	...
	//STUPID FAGGOT AIDS
			...
			self.TextArea1:SetText("--Welcome! LiteScript 0.5 Alpha by John '[MT]OMalley' Dorian--")
			self.TextArea1:SetPos(16, Y)
			Y = Y+16
			
			self.TextArea2 = vgui.Create("Label", self.Info)
			self.TextArea2:SetText("If you're here now, you're most likely a member of [MT] or friend of [MT]OMalley, or of [HL2Land]John Dorian.\n\nRULES\n\n\n\nPowergaming: A player can be described as a powergamer if he/she presumes or declares that his or her own action \nagainst another player character is successful without giving the other player character the freedom to act on his own \nprerogative (e.g. /me punches you). They may also be a player who tries to force others to participate in role-playing \nthey don't want to engage in. For instance, a player who unilaterally describes his character as doing something with (or to)\nanother character that would usually require the other to play along - such as having a fight or\na sexual encounter - is considered to be powergaming.\n\n")
