...
function MoneyHud() 
	...
	draw.RoundedBox( 4, 10, ScrH() - 125, 106+pboxw , 85, Color( 100, 100, 100, 150 ) )
	draw.RoundedBox( 4, 13, ScrH() - 122, 100+pboxw , 79, Color( 0, 0, 0, 200 ) )
	draw.RoundedBox( 4, 10, ScrH() - 125, 106+pboxw , 20, Color( 100, 100, 100, 200 ) )
	draw.SimpleText("Player", "ChatFont", 20,  ScrH() - 122, Color(255, 255, 255, 255), 0, 0)  
	draw.SimpleText(client:GetNWInt( "money" ) .. " Credits", "ChatFont", 20,  ScrH() - 100, Color(255, 255, 255, 255), 0, 0)  
	draw.SimpleText(client:GetNWString( "jobtitle" ) .. " ", "ChatFont", 20,  ScrH() - 80, Color(255, 255, 255, 255), 0, 0)  
	draw.SimpleText(client:Nick() .. " ", "ChatFont", 20,  ScrH() - 60, Color(255, 255, 255, 255), 0, 0)  
end                                                                
